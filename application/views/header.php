...
<?php 
// print_r($this->session->userdata('logged_in')["certificate_gen"]);
// print_r($this->session->userdata('logged_in')["certificate_gen"]." ".$this->session->userdata('logged_in')["setting"] );
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="javascript:void(0)">
        ...
        <div class="sidebar-brand-text mx-3"><?php if($hres[0]['setting_value']==""){ ?>PORTAL <sup></sup><?php }else{ echo $hres[0]['setting_value']; }?> </div>
...
?>
     ...
     <!-- Nav Item - Pages Collapse Menu -->
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseCertify" aria-expanded="true" aria-controls="collapseCertify">
          <i class="fas fa-fw fa-certificate"></i>
          <span><?php echo $this->lang->line('certificate_menu');?></span>
        </a>
        <div id="collapseCertify" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
          
            <?php 
if(in_array('Add',explode(',',$logged_in['certificate_gen']))){
?> 
            <a class="collapse-item" href="<?php echo site_url('certificate/new_certificate');?>"><?php echo $this->lang->line('certificate_menu_new');?></a>
<?php 
}

if(in_array('List',explode(',',$logged_in['certificate_gen'])) || in_array('List_all',explode(',',$logged_in['certificate_gen']))){
?> 
            <a class="collapse-item" href="<?php echo site_url('certificate');?>"><?php echo $this->lang->line('certificate_menu_list');?></a>
<?php 
}
?>
      ...
      <li class="nav-item">
        ...
        <div id="collapseSetting" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a style="display:none" class="collapse-item" href="<?php echo site_url('user/group_list');?>"><?php echo $this->lang->line('group_list');?></a> 
           ...
           <a style="display:none" class="collapse-item" href="<?php echo site_url('account');?>"><?php echo $this->lang->line('account_type');?></a></a> 
           <a style="display:none" class="collapse-item" href="<?php echo site_url('user/custom_fields');?>"><?php echo $this->lang->line('custom_forms');?></a>  
...
?>  
<a href="<?php echo site_url('user/switch_group');?>" class="btn btn-danger" style="border-radius:0px;display:none;"><?php echo $this->lang->line('change_group');?></a>
<?php 
}
?>
