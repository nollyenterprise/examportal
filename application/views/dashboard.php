...
$cal=number_format(((($revenue_months[$todaymonth]-$revenue_months[$pastmonth])/($revenue_months[$pastmonth] == 0 ? 1 : $revenue_months[$pastmonth]))*100),'2','.','');
 if($cal < 0){
?>
...
<script>
  // Don't check for update on software
// update_check('5');
</script>
