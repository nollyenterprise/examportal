...
<head>
  ...
  <link rel="shortcut icon" href="<?php echo base_url();?>images/<?php echo $this->lang->line('savsoft_quiz_icon');?>" type="image/x-icon">
      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block  " style="background:url('<?php echo base_url();?>images/people-sittin.jpg');background-position: center;
    background-size: cover;"></div>
              <div class="col-lg-6">
				...
				?>
					...
					<?php if($hres[0]['setting_value']==""){ ?>PORTAL <sup></sup><?php }else{ echo $hres[0]['setting_value']; }?> 
...
if($this->config->item('open_quiz')){
	?>			 
			...
			?>
				  ...
				  <p style="margin-top:40px;"><a class="small" href="https://tekxus.com" style="float:right;">Powered by Tekxus</a></p>
